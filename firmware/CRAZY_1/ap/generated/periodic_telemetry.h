...
#define TELEMETRY_PPRZ_MSG_STAB_ATTITUDE_IDX 9
#define TELEMETRY_PPRZ_MSG_STATE_FILTER_STATUS_IDX 10
#define TELEMETRY_PPRZ_MSG_UART_ERRORS_IDX 11
#define TELEMETRY_PPRZ_MSG_GUIDANCE_INDI_HYBRID_IDX 12
#define TELEMETRY_PPRZ_MSG_STAB_ATTITUDE_REF_FLOAT_IDX 13
#define TELEMETRY_PPRZ_MSG_BARO_RAW_IDX 14
#define TELEMETRY_PPRZ_MSG_ROTORCRAFT_CAM_IDX 15
#define TELEMETRY_PPRZ_MSG_ROTORCRAFT_NAV_STATUS_IDX 16
#define TELEMETRY_PPRZ_MSG_ROTORCRAFT_FP_IDX 17
#define TELEMETRY_PPRZ_MSG_HFF_GPS_IDX 18
#define TELEMETRY_PPRZ_MSG_STAB_ATTITUDE_FLOAT_IDX 19
#define TELEMETRY_PPRZ_MSG_AHRS_REF_QUAT_IDX 20
#define TELEMETRY_PPRZ_MSG_ROTORCRAFT_TUNE_HOVER_IDX 21
#define TELEMETRY_PPRZ_MSG_WP_MOVED_IDX 22
#define TELEMETRY_PPRZ_MSG_GUIDANCE_H_REF_INT_IDX 23
#define TELEMETRY_PPRZ_MSG_RATE_LOOP_IDX 24
#define TELEMETRY_PPRZ_MSG_IMU_GYRO_RAW_IDX 25
#define TELEMETRY_PPRZ_MSG_GPS_INT_IDX 26
#define TELEMETRY_PPRZ_MSG_OPTICAL_FLOW_HOVER_IDX 27
#define TELEMETRY_PPRZ_MSG_LIDAR_IDX 28
#define TELEMETRY_PPRZ_MSG_HOVER_LOOP_IDX 29
#define TELEMETRY_PPRZ_MSG_VECTORNAV_INFO_IDX 30
#define TELEMETRY_PPRZ_MSG_INS_Z_IDX 31
#define TELEMETRY_PPRZ_MSG_IMU_MAG_RAW_IDX 32
#define TELEMETRY_PPRZ_MSG_EFF_MAT_G_IDX 33
#define TELEMETRY_PPRZ_MSG_AIRSPEED_RAW_IDX 34
#define TELEMETRY_PPRZ_MSG_DIVERGENCE_IDX 35
#define TELEMETRY_PPRZ_MSG_AHRS_QUAT_INT_IDX 36
#define TELEMETRY_PPRZ_MSG_BEBOP_ACTUATORS_IDX 37
#define TELEMETRY_PPRZ_MSG_IMU_ACCEL_RAW_IDX 38
#define TELEMETRY_PPRZ_MSG_ROTORCRAFT_STATUS_IDX 39
#define TELEMETRY_PPRZ_MSG_IMU_MAG_CURRENT_CALIBRATION_IDX 40
#define TELEMETRY_PPRZ_MSG_GUIDANCE_H_INT_IDX 41
#define TELEMETRY_PPRZ_MSG_HFF_IDX 42
#define TELEMETRY_PPRZ_MSG_GEO_MAG_IDX 43
#define TELEMETRY_PPRZ_MSG_IMU_ACCEL_SCALED_IDX 44
#define TELEMETRY_PPRZ_MSG_ROTORCRAFT_RADIO_CONTROL_IDX 45
#define TELEMETRY_PPRZ_MSG_AIR_DATA_IDX 46
#define TELEMETRY_PPRZ_MSG_VFF_IDX 47
#define TELEMETRY_PPRZ_MSG_INS_EKF2_IDX 48
#define TELEMETRY_PPRZ_MSG_OPTIC_FLOW_EST_IDX 49
#define TELEMETRY_PPRZ_MSG_AHRS_EULER_IDX 50
#define TELEMETRY_PPRZ_MSG_AUTOPILOT_VERSION_IDX 51
#define TELEMETRY_PPRZ_MSG_LOGGER_STATUS_IDX 52
#define TELEMETRY_PPRZ_MSG_INS_IDX 53
#define TELEMETRY_PPRZ_MSG_FILTER_IDX 54
#define TELEMETRY_PPRZ_MSG_VFF_EXTENDED_IDX 55
#define TELEMETRY_PPRZ_MSG_IMU_MAG_SCALED_IDX 56
#define TELEMETRY_PPRZ_MSG_SUPERBITRF_IDX 57
#define TELEMETRY_PPRZ_MSG_RC_IDX 58
#define TELEMETRY_PPRZ_MSG_ROTORCRAFT_CMD_IDX 59
#define TELEMETRY_PPRZ_MSG_HFF_DBG_IDX 60
#define TELEMETRY_PPRZ_MSG_WIND_INFO_RET_IDX 61
#define TELEMETRY_PPRZ_MSG_ARDRONE_NAVDATA_IDX 62
#define TELEMETRY_PPRZ_MSG_STAB_ATTITUDE_INT_IDX 63
#define TELEMETRY_PPRZ_MSG_SURVEY_IDX 64
#define TELEMETRY_PPRZ_MSG_ESC_IDX 65
#define TELEMETRY_PPRZ_MSG_AHRS_GYRO_BIAS_INT_IDX 66
#define TELEMETRY_PPRZ_MSG_IMU_GYRO_SCALED_IDX 67
#define TELEMETRY_PPRZ_MSG_ALIVE_IDX 68
#define TELEMETRY_PPRZ_MSG_DRAGSPEED_IDX 69
#define TELEMETRY_PPRZ_MSG_VISION_POSITION_ESTIMATE_IDX 70
#define TELEMETRY_PPRZ_MSG_VISUALTARGET_IDX 71
#define TELEMETRY_PPRZ_MSG_DATALINK_REPORT_IDX 72
#define TELEMETRY_PPRZ_MSG_DL_VALUE_IDX 73
#define TELEMETRY_PPRZ_MSG_GPS_RTK_IDX 74
#define TELEMETRY_PPRZ_MSG_INS_REF_IDX 75
#define TELEMETRY_PPRZ_NB_MSG 76
...
#define TELEMETRY_PPRZ_CBS { \
  ...
  {.id=PPRZ_MSG_ID_STAB_ATTITUDE, .slots={ NULL }}, \
  {.id=PPRZ_MSG_ID_STATE_FILTER_STATUS, .slots={ NULL }}, \
  {.id=PPRZ_MSG_ID_UART_ERRORS, .slots={ NULL }}, \
  {.id=PPRZ_MSG_ID_GUIDANCE_INDI_HYBRID, .slots={ NULL }}, \
  ...
  {.id=PPRZ_MSG_ID_EFF_MAT_G, .slots={ NULL }}, \
  {.id=PPRZ_MSG_ID_AIRSPEED_RAW, .slots={ NULL }}, \
  ...
  {.id=PPRZ_MSG_ID_IMU_MAG_CURRENT_CALIBRATION, .slots={ NULL }}, \
...
#define PERIOD_AHRS_REF_QUAT_Main_0 (0.5)
#define PERIOD_STAB_ATTITUDE_Main_0 (.25)
#define PERIOD_EFF_MAT_G_Main_0 (2.0)
...
#define PERIOD_IMU_MAG_CURRENT_CALIBRATION_Main_2 (.05)
#define PERIOD_ARDRONE_NAVDATA_Main_2 (.05)
#define PERIOD_AIRSPEED_RAW_Main_2 (0.1)
...
#define PERIOD_STAB_ATTITUDE_Main_7 (.25)
#define PERIOD_EFF_MAT_G_Main_7 (2.0)
...
#define PERIOD_GUIDANCE_INDI_HYBRID_Main_9 (0.1)
...
static inline void periodic_telemetry_send_Main(struct periodic_telemetry *telemetry, struct transport_tx *trans, struct link_device *dev) {
  if (telemetry_mode_Main == TELEMETRY_MODE_Main_default) {
    ...
    static uint32_t i21 = 0; i21++; if (i21>= (uint32_t)(TELEMETRY_FREQUENCY*2.0)) i21=0;
    uint8_t j;
    ...
    if (i21 == (uint32_t)(TELEMETRY_FREQUENCY*2.0*0.300000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
        if (telemetry->cbs[TELEMETRY_PPRZ_MSG_EFF_MAT_G_IDX].slots[j] != NULL)
          telemetry->cbs[TELEMETRY_PPRZ_MSG_EFF_MAT_G_IDX].slots[j](trans, dev);
        else break;
      }
#if USE_PERIODIC_TELEMETRY_REPORT
      if (j == 0) periodic_telemetry_err_report(TELEMETRY_PROCESS_Main, telemetry_mode_Main, PPRZ_MSG_ID_EFF_MAT_G);
#endif
    }
    ...
    if (i10 == (uint32_t)(TELEMETRY_FREQUENCY*.25*0.200000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
        if (telemetry->cbs[TELEMETRY_PPRZ_MSG_STAB_ATTITUDE_IDX].slots[j] != NULL)
          telemetry->cbs[TELEMETRY_PPRZ_MSG_STAB_ATTITUDE_IDX].slots[j](trans, dev);
        else break;
      }
#if USE_PERIODIC_TELEMETRY_REPORT
      if (j == 0) periodic_telemetry_err_report(TELEMETRY_PROCESS_Main, telemetry_mode_Main, PPRZ_MSG_ID_STAB_ATTITUDE);
#endif
    }
  ...
  if (telemetry_mode_Main == TELEMETRY_MODE_Main_raw_sensors) {
    ...
    if (i6 == (uint32_t)(TELEMETRY_FREQUENCY*0.1*0.000000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
        if (telemetry->cbs[TELEMETRY_PPRZ_MSG_AIRSPEED_RAW_IDX].slots[j] != NULL)
          telemetry->cbs[TELEMETRY_PPRZ_MSG_AIRSPEED_RAW_IDX].slots[j](trans, dev);
        else break;
      }
#if USE_PERIODIC_TELEMETRY_REPORT
      if (j == 0) periodic_telemetry_err_report(TELEMETRY_PROCESS_Main, telemetry_mode_Main, PPRZ_MSG_ID_AIRSPEED_RAW);
#endif
    }
    ...
    if (i4 == (uint32_t)(TELEMETRY_FREQUENCY*.05*0.900000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i4 == (uint32_t)(TELEMETRY_FREQUENCY*.05*0.800000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
        if (telemetry->cbs[TELEMETRY_PPRZ_MSG_IMU_MAG_CURRENT_CALIBRATION_IDX].slots[j] != NULL)
          telemetry->cbs[TELEMETRY_PPRZ_MSG_IMU_MAG_CURRENT_CALIBRATION_IDX].slots[j](trans, dev);
        else break;
      }
#if USE_PERIODIC_TELEMETRY_REPORT
      if (j == 0) periodic_telemetry_err_report(TELEMETRY_PROCESS_Main, telemetry_mode_Main, PPRZ_MSG_ID_IMU_MAG_CURRENT_CALIBRATION);
#endif
    }
  ...
  if (telemetry_mode_Main == TELEMETRY_MODE_Main_vel_guidance) {
    ...
    static uint32_t i3 = 0; i3++; if (i3>= (uint32_t)(TELEMETRY_FREQUENCY*0.1)) i3=0;
    ...
    static uint32_t i8 = 0; i8++; if (i8>= (uint32_t)(TELEMETRY_FREQUENCY*1.3)) i8=0;
    static uint32_t i9 = 0; i9++; if (i9>= (uint32_t)(TELEMETRY_FREQUENCY*1.0)) i9=0;
    uint8_t j;
    if (i7 == (uint32_t)(TELEMETRY_FREQUENCY*5.1*0.700000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
        if (telemetry->cbs[TELEMETRY_PPRZ_MSG_INS_REF_IDX].slots[j] != NULL)
          telemetry->cbs[TELEMETRY_PPRZ_MSG_INS_REF_IDX].slots[j](trans, dev);
        else break;
    ...
    if (i5 == (uint32_t)(TELEMETRY_FREQUENCY*1.2*0.500000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
        if (telemetry->cbs[TELEMETRY_PPRZ_MSG_ROTORCRAFT_STATUS_IDX].slots[j] != NULL)
          telemetry->cbs[TELEMETRY_PPRZ_MSG_ROTORCRAFT_STATUS_IDX].slots[j](trans, dev);
        else break;
    ...
    if (i9 == (uint32_t)(TELEMETRY_FREQUENCY*1.0*0.000000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
        if (telemetry->cbs[TELEMETRY_PPRZ_MSG_INS_IDX].slots[j] != NULL)
          telemetry->cbs[TELEMETRY_PPRZ_MSG_INS_IDX].slots[j](trans, dev);
        else break;
    ...
    if (i9 == (uint32_t)(TELEMETRY_FREQUENCY*1.0*0.900000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
        if (telemetry->cbs[TELEMETRY_PPRZ_MSG_GPS_INT_IDX].slots[j] != NULL)
          telemetry->cbs[TELEMETRY_PPRZ_MSG_GPS_INT_IDX].slots[j](trans, dev);
        else break;
    ...
    if (i4 == (uint32_t)(TELEMETRY_FREQUENCY*0.8*0.400000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
        if (telemetry->cbs[TELEMETRY_PPRZ_MSG_ROTORCRAFT_FP_IDX].slots[j] != NULL)
          telemetry->cbs[TELEMETRY_PPRZ_MSG_ROTORCRAFT_FP_IDX].slots[j](trans, dev);
        else break;
    ...
    if (i3 == (uint32_t)(TELEMETRY_FREQUENCY*0.1*0.300000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
        if (telemetry->cbs[TELEMETRY_PPRZ_MSG_GUIDANCE_INDI_HYBRID_IDX].slots[j] != NULL)
          telemetry->cbs[TELEMETRY_PPRZ_MSG_GUIDANCE_INDI_HYBRID_IDX].slots[j](trans, dev);
        else break;
      }
#if USE_PERIODIC_TELEMETRY_REPORT
      if (j == 0) periodic_telemetry_err_report(TELEMETRY_PROCESS_Main, telemetry_mode_Main, PPRZ_MSG_ID_GUIDANCE_INDI_HYBRID);
#endif
    }
...
#define PERIOD_ESC_FlightRecorder_0 (0.05)
...
static inline void periodic_telemetry_send_FlightRecorder(struct periodic_telemetry *telemetry, struct transport_tx *trans, struct link_device *dev) {
  if (telemetry_mode_FlightRecorder == TELEMETRY_MODE_FlightRecorder_default) {
    ...
    if (i15 == (uint32_t)(TELEMETRY_FREQUENCY*0.05*0.100000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
